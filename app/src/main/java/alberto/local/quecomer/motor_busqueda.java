...
public class motor_busqueda {
    ...
    private TreeMap<Integer, String> categorias_recetas;
    ...
    public motor_busqueda(gestorBD mgestor, Context p_contexto) {
        ...
        listado_ingredientes = new ArrayList<>();
        tabla_puntajes = new TreeMap<>();
        categorias_recetas = new TreeMap<>();
    }

    public motor_busqueda(gestorBD gestor_base, ArrayList<ingrediente> listado_ingredientes, Context contexto, TreeMap<Integer, Double> tabla_puntajes, TreeMap<Integer, String> pcategorias) {
    ...
    public TreeMap<Integer, String> getCategorias_recetas() {
    ...
    public void procesar_ingrediente(ingrediente p_ingrediente) {
        ...
        Cursor mi_cursor = bd.rawQuery(
                "SELECT RECETAS.ID_RECETA, INGREDIENTES.ID_INGREDIENTE, CANTIDAD, RECETAS.CATEGORIAS FROM RECETA_INGREDIENTES INNER JOIN " +
                        ...
                        "WHERE INGREDIENTES.NOMBRE= '" + p_ingrediente.nombre_ingrediente + "'", null);
        if (mi_cursor.moveToFirst()) {
            do {
